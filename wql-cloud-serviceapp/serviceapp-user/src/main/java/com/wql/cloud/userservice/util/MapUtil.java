...
public class MapUtil extends MapUtils {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static Map<String, String> castMapNotNull(Object object) {
		Map<String, String> remap = new HashMap<String, String>();
		String jsonStr = JsonUtil.buildNonNullBinder().toJson(object);
		remap = (Map<String, String>) JsonUtil.buildNonNullBinder().getJsonToMap(jsonStr, String.class, String.class);
		return remap;
	}
