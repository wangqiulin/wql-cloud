package com.wql.cloud.basic.zookeeper.lock.impl;
...
public class DistributedLock implements Lock {
    ...
    private static final String ZOOKEEPER_IP_PORT = "192.168.1.90:2181,192.168.1.91:2181,192.168.1.92:2181";
    ...
    private void waitForLock() {
        ...
        // 对此小节点进行监听,即beforePath-给排在前面的的节点增加数据删除的watcher
